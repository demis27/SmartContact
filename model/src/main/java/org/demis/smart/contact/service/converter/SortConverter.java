package org.demis.smart.contact.service.converter;
...
public class SortConverter {
    ...
    public static final Sort convert(List<org.demis.smart.contact.Sort> sorts) {
        List<Sort.Order> dataSorts = new ArrayList<Sort.Order>();
        for (org.demis.smart.contact.Sort sort: sorts) {
